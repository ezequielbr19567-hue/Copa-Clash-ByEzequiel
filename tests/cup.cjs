...
(async()=>{
  const {
    ...
    calculateGroupStandings,knockoutSeedPlan,roundRobinSchedule,parseVictoryTime,formatVictoryTime
  ...
  assert.deepEqual(normalizeCupFormat({groups:['1','2','1',''],qualifiers_per_group:4,points_win:3,points_draw:0,points_loss:0,points_loss_three_crowns:-1}),{
    groups:['1','2'],qualifiers_per_group:4,points_win:3,points_draw:0,points_loss:0,points_loss_three_crowns:-1,knockout_mode:'AUTO_CROSS'
  });
