...
begin
  ...
  if cup_id is null then
    ...
    values ('Copa','CUP','SOLO','2026',true,'{"groups":["1","2","3","4"],"qualifiers_per_group":4,"points_win":3,"points_draw":1,"points_loss":0,"points_loss_three_crowns":-1,"knockout_mode":"AUTO_CROSS"}'::jsonb)
    returning id into cup_id;
  else
    update public.competitions
    set mode='SOLO',
        format_config='{"groups":["1","2","3","4"],"qualifiers_per_group":4,"points_win":3,"points_draw":1,"points_loss":0,"points_loss_three_crowns":-1,"knockout_mode":"AUTO_CROSS"}'::jsonb
    where id=cup_id;
  end if;
