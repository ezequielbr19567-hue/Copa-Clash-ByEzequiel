...
create table if not exists public.competitions (
  ...
  format_config jsonb not null default '{"groups":["1","2","3","4"],"qualifiers_per_group":4,"points_win":3,"points_draw":1,"points_loss":0,"points_loss_three_crowns":-1,"knockout_mode":"AUTO_CROSS"}'::jsonb check (jsonb_typeof(format_config)='object'),
  created_at timestamptz not null default now()
);
