...
select 'Copa Demo','CUP','SOLO','2026',true,'{"groups":["1","2"],"qualifiers_per_group":2,"points_win":3,"points_draw":0,"points_loss":0,"points_loss_three_crowns":-1,"knockout_mode":"AUTO_CROSS"}'::jsonb
