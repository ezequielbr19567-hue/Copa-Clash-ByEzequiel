...
alter table public.competitions alter column format_config set default '{"groups":["1","2","3","4"],"qualifiers_per_group":4,"points_win":3,"points_draw":1,"points_loss":0,"points_loss_three_crowns":-1,"knockout_mode":"AUTO_CROSS"}'::jsonb;

update public.competitions
set format_config = '{"points_win":3,"points_draw":1,"points_loss":0,"points_loss_three_crowns":-1,"knockout_mode":"AUTO_CROSS"}'::jsonb || coalesce(format_config,'{}'::jsonb)
where kind='CUP';
