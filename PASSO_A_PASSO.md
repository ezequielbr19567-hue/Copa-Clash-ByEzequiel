...
Quando todos os jogos de todos os grupos terminarem, as oitavas são geradas automaticamente com 4 classificados por grupo.

O Grupo 4 cruza com o Grupo 1 de forma invertida: 1º×4º, 2º×3º, 3º×2º, 4º×1º. O Grupo 3 cruza da mesma forma com o Grupo 2.

Depois, cada resultado do mata-mata alimenta automaticamente quartas, semifinal e final. Há também um botão **Sincronizar mata-mata agora** em Admin → Grupos para recuperação manual caso você queira forçar uma nova verificação.
...
YouTube, Shorts, Vimeo e vídeos HTTPS diretos são exibidos responsivamente no site público e só carregam quando necessário.
